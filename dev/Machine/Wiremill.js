...
ETMachine.setDrop("wiremill",BlockID.machineCasing);
...
ETMachine.registerMachine(BlockID.wiremill,{
    defaultValues:{
        tier:2,
        meta:0,
        work_time:320,
	...
	tick:function(){
        ...
        var input = this.container.getSlot("slotInput"),recipe = ETRecipe.getRecipeResult("Wiremill",input.id,input.data);
