...
var GuiFireGenerator = new UI.StandartWindow({
	...
	elements:{
		...
		"scaleBurn":{type:"scale",x:450 + GUI_SCALE * 3,y:225 + GUI_SCALE * 2,direction:1,value:0.5,bitmap:"fireScale",scale:GUI_SCALE},
		...
		"slotFuel":{type:"slot",x:450,y:300,bitmap:"slotFuel",isValid:function(id,count,data){return Recipes.getFuelBurnDuration(id,data) > 0;}}
	}
});
