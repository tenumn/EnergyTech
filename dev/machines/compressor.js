...
MachineRegistry.setDrop("compressor",BlockID.machineCasing);
...
MachineRegistry.registerMachine(BlockID.compressor,{
    defaultValues:{
        tier:2,
        meta:0,
        work_time:320,
    ...
    tick:function(){
        ...
        var recipe = RecipeRegistry.getMachineRecipeOutput("Compressor",input.id,input.count,input.data);
