...
Block.createBlock("blastFurnace",[
    {name:"Blast Furnace",texture:[["blast_furnace_bottom",0],["blast_furnace_top",0],["blast_furnace_side",0],["blast_furnace",0],["blast_furnace_side",0],["blast_furnace_side",0]],inCreative:true}
],"opaque");
TileRenderer.setStandartModel(BlockID.blastFurnace,[["blast_furnace_bottom",0],["blast_furnace_top",0],["blast_furnace_side",0],["blast_furnace",0],["blast_furnace_side",0],["blast_furnace_side",0]]);
TileRenderer.registerRotationModel(BlockID.blastFurnace,0,[["blast_furnace_bottom",0],["blast_furnace_top",0],["blast_furnace_side",0],["blast_furnace",0],["blast_furnace_side",0],["blast_furnace_side",0]]);
TileRenderer.registerRotationModel(BlockID.blastFurnace,4,[["blast_furnace_bottom",0],["blast_furnace_top",0],["blast_furnace_side",0],["blast_furnace",1],["blast_furnace_side",0],["blast_furnace_side",0]]);
...
ETMachine.registerPrototype(BlockID.blastFurnace,{
    defaultValues:{
        meta:0,
        burn:0,
        burnMax:0,
    ...
    tick:function(){
        ...
        var recipe = ETRecipe.getMachineRecipeOutput("BlastFurnace",input.id,input.count,input.data);
