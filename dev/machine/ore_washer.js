...
var GuiOreWasher = new UI.StandartWindow({
    ...
    elements:{
        ...
        "slotLiquid1":{type:"slot",x:720,y:325,bitmap:"slot.cell",isValid:function(id,count,data){return Liquid.getItemLiquid(id,data) == "water";}},
        "slotLiquid2":{type:"slot",x:780,y:325,bitmap:"slot.cell",isValid:function(){return false;}},
