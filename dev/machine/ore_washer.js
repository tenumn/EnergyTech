...
var GuiOreWasher = new UI.StandartWindow({
    ...
    elements:{
        ...
        "slotLiquid1":{type:"slot",x:720,y:400,bitmap:"cell_slot",isValid:function(id,count,data){return LiquidRegistry.getItemLiquid(id,data) == "water";}},
		"slotLiquid2":{type:"slot",x:780,y:400,bitmap:"cell_slot",isValid:function(){return false;}}
    }
});
