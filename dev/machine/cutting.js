...
Machine.setDrop("cutting",BlockID.machineCasing,1);
...
Machine.registerEUMachine(BlockID.cutting,{
    defaultValues:{
        meta:0,
        tier:2,
        progress:0,
	...
	tick:function(){
        ...
        var input = this.container.getSlot("slotInput"),recipe = Recipe.getRecipeResult("Cutting",[input.id,input.data]);
...
StorageInterface.createInterface(BlockID.cutting,{
	...
	isValidInput:function(item){
		return Recipe.getRecipeResult("Cutting",[item.id,item.data])?true:false;
	}
});