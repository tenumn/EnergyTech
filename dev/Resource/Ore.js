...
CreateOre = function(name,data){
    var ore = FileTools.ReadJSON(__dir__ + "res/config/ore.json")[name.toLowerCase()];
    ...
    if(!data.ore){
        ...
        Item.addCreativeGroup("ET-Ore",Translation.translate("Ore"),[BlockID["ore" + name]]);

        if(ore.enabled){
            Callback.addCallback("GenerateChunkUnderground",function(chunkX,chunkZ){
                for(var i = 0;i < ore.count;i++){
                    var coords = GenerationUtils.randomCoords(chunkX,chunkZ,ore.minHeight,ore.maxHeight);
                    GenerationUtils.generateOre(coords.x,coords.y,coords.z,BlockID["ore" + name],0,ore.size);
                }
            });
        }
    }
    ...
    if(!data.oreNether){
        ...
        Item.addCreativeGroup("ET-NetherOre",Translation.translate("Nether Ore"),[BlockID["oreNether" + name]]);

        if(ore.enabled){
            Callback.addCallback("GenerateNetherChunk",function(chunkX,chunkZ){
                for(var i = 0;i < ore.count;i++){
                    var coords = GenerationUtils.randomCoords(chunkX,chunkZ,ore.minHeight,ore.maxHeight);
                    GenerationUtils.generateOre(coords.x,coords.y,coords.z,BlockID["oreNether" + name],0,ore.size);
                }
            });
        }
    }
    ...
    if(!data.oreEnder){
        ...
        Item.addCreativeGroup("ET-EnderOre",Translation.translate("Ender Ore"),[BlockID["oreEnder" + name]]);

        if(ore.enabled){
            Callback.addCallback("GenerateEndChunk",function(chunkX,chunkZ){
                for(var i = 0;i < ore.count;i++){
                    var coords = GenerationUtils.randomCoords(chunkX,chunkZ,ore.minHeight,ore.maxHeight);
                    GenerationUtils.generateOre(coords.x,coords.y,coords.z,BlockID["oreEnder" + name],0,ore.size);
                }
            });
        }
    }
...
Callback.addCallback("PreLoaded",function(){
    ...
    Tool.setHammerDestroyDrop(BlockID.oreTin         ,ItemID.oreChunkTin         ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreLead        ,ItemID.oreChunkLead        ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreLithium     ,ItemID.oreChunkLithium     ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreTungsten    ,ItemID.oreChunkTungsten    ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreAntimony    ,ItemID.oreChunkAntimony    ,4,0,true);
    ...
    Tool.setHammerDestroyDrop(BlockID.oreAluminium   ,ItemID.oreChunkAluminium   ,4,0,true);
    
    Tool.setHammerDestroyDrop(BlockID.oreNetherCopper      ,ItemID.oreChunkNetherCopper      ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherTetrahedrite,ItemID.oreChunkNetherTetrahedrite,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherTin         ,ItemID.oreChunkNetherTin         ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherLead        ,ItemID.oreChunkNetherLead        ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherLithium     ,ItemID.oreChunkNetherLithium     ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherTungsten    ,ItemID.oreChunkNetherTungsten    ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherAntimony    ,ItemID.oreChunkNetherAntimony    ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherUranium     ,ItemID.oreChunkNetherUranium     ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherSilver      ,ItemID.oreChunkNetherSilver      ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreNetherAluminium   ,ItemID.oreChunkNetherAluminium   ,4,0,true);
    
    Tool.setHammerDestroyDrop(BlockID.oreEnderCopper      ,ItemID.oreChunkEnderCopper      ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderTetrahedrite,ItemID.oreChunkEnderTetrahedrite,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderTin         ,ItemID.oreChunkEnderTin         ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderLead        ,ItemID.oreChunkEnderLead        ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderLithium     ,ItemID.oreChunkEnderLithium     ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderTungsten    ,ItemID.oreChunkEnderTungsten    ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderAntimony    ,ItemID.oreChunkEnderAntimony    ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderUranium     ,ItemID.oreChunkEnderUranium     ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderSilver      ,ItemID.oreChunkEnderSilver      ,4,0,true);
    Tool.setHammerDestroyDrop(BlockID.oreEnderAluminium   ,ItemID.oreChunkEnderAluminium   ,4,0,true);
    ...
    Recipe.addBlastFurnaceRecipe({id:BlockID.oreNetherTungsten,data:0},[{id:ItemID.ingotTungsten,count:1,data:0},{id:ItemID.slag,count:1,data:0}]);
    Recipe.addBlastFurnaceRecipe({id:BlockID.oreEnderTungsten ,data:0},[{id:ItemID.ingotTungsten,count:1,data:0},{id:ItemID.slag,count:1,data:0}]);
});
