...
ToolAPI.setTool(ItemID.hammerBronze,"bronze",ToolType.pickaxe);
...
Callback.addCallback("PreLoaded",function(){
    ...
    for(let i = 0;i < file.length;i++){
        for(let ii = 0;ii < hammer.length;ii++){
            Recipe.addShapedRecipe({id:ItemID.swordBronze,count:1,data:0},["cad"," a "," b "],["a",ItemID.plateBronze,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            Recipe.addShapedRecipe({id:ItemID.shovelBronze,count:1,data:0},["cad"," b "," b "],["a",ItemID.plateBronze,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            Recipe.addShapedRecipe({id:ItemID.pickaxeBronze,count:1,data:0},["aca","dbe"," b "],["a",ItemID.plateBronze,0,"b",280,0,"c",ItemID.ingotBronze,0,"d",file[i],0,"e",hammer[ii],0],{3:1,5:1});
            Recipe.addShapedRecipe({id:ItemID.axeBronze,count:1,data:0},["acd","abe"," b "],["a",ItemID.plateBronze,0,"b",280,0,"c",ItemID.ingotBronze,0,"d",file[i],0,"e",hammer[ii],0],{2:1,5:1});
            Recipe.addShapedRecipe({id:ItemID.hoeBronze,count:1,data:0},["aac","db "," b "],["a",ItemID.plateBronze,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{2:1,3:1});
        }
        Recipe.addShapedRecipe({id:ItemID.wrenchBronze,count:1,data:0},[" ac","eba","de "],["a",ItemID.plateBronze,0,"b",ItemID.ingotBronze,0,"c",file[i],-1,"d",ItemID.ringBronze,0,"e",ItemID.stickBronze,0],{2:1});
    }
