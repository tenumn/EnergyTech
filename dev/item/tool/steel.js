...
Callback.addCallback("PreLoaded",function(){
    ...
    for(let i = 0;i < file.length;i++){
        for(let ii = 0;ii < hammer.length;ii++){
            Recipe.addShapedRecipe({id:ItemID.swordSteel,count:1,data:0},["cad"," a "," b "],["a",ItemID.plateSteel,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            Recipe.addShapedRecipe({id:ItemID.shovelSteel,count:1,data:0},["cad"," b "," b "],["a",ItemID.plateSteel,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            Recipe.addShapedRecipe({id:ItemID.pickaxeSteel,count:1,data:0},["aca","dbe"," b "],["a",ItemID.plateSteel,0,"b",280,0,"c",ItemID.ingotSteel,0,"d",file[i],0,"e",hammer[ii],0],{3:1,5:1});
            Recipe.addShapedRecipe({id:ItemID.axeSteel,count:1,data:0},["acd","abe"," b "],["a",ItemID.plateSteel,0,"b",280,0,"c",ItemID.ingotSteel,0,"d",file[i],0,"e",hammer[ii],0],{2:1,5:1});
            Recipe.addShapedRecipe({id:ItemID.hoeSteel,count:1,data:0},["aac","db "," b "],["a",ItemID.plateSteel,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{2:1,3:1});
        }
        Recipe.addShapedRecipe({id:ItemID.wrenchSteel,count:1,data:0},[" ac","eba","de "],["a",ItemID.plateSteel,0,"b",ItemID.ingotSteel,0,"c",file[i],-1,"d",ItemID.ringSteel,0,"e",ItemID.stickSteel,0],{2:1});
    }
