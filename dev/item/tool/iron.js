...
Callback.addCallback("PreLoaded",function(){
    ...
    for(let i = 0;i < file.length;i++){
        ETRecipe.addShapedRecipe({id:ItemID.wrenchIron,count:1,data:0},[" ac","eba","de "],["a",ItemID.plateIron,0,"b",265,0,"c",file[i],-1,"d",ItemID.ringIron,0,"e",ItemID.stickIron,0],{2:1});
    }
