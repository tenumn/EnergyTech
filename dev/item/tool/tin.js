...
Callback.addCallback("PreLoaded",function(){
    ...
    for(let i = 0;i < file.length;i++){
        for(let ii = 0;ii < hammer.length;ii++){
            ETRecipe.addShapedRecipe({id:ItemID.swordTin,count:1,data:0},["cad"," a "," b "],["a",ItemID.plateTin,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            ETRecipe.addShapedRecipe({id:ItemID.shovelTin,count:1,data:0},["cad"," b "," b "],["a",ItemID.plateTin,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{0:1,2:1});
            ETRecipe.addShapedRecipe({id:ItemID.pickaxeTin,count:1,data:0},["aca","dbe"," b "],["a",ItemID.plateTin,0,"b",280,0,"c",ItemID.ingotTin,0,"d",file[i],0,"e",hammer[ii],0],{3:1,5:1});
            ETRecipe.addShapedRecipe({id:ItemID.axeTin,count:1,data:0},["acd","abe"," b "],["a",ItemID.plateTin,0,"b",280,0,"c",ItemID.ingotTin,0,"d",file[i],0,"e",hammer[ii],0],{2:1,5:1});
            ETRecipe.addShapedRecipe({id:ItemID.hoeTin,count:1,data:0},["aac","db "," b "],["a",ItemID.plateTin,0,"b",280,0,"c",file[i],0,"d",hammer[ii],0],{2:1,3:1});
        }
