...
Callback.addCallback("PreLoaded",function(){
    ...
    ETRecipe.addHammerRecipe({id:ItemID.crushedUranium     ,count:1,data:0},[{id:BlockID.oreUranium     ,data:0}]);
    ETRecipe.addHammerRecipe({id:ItemID.crushedSilver      ,count:1,data:0},[{id:BlockID.oreSilver      ,data:0}]);
    ETRecipe.addHammerRecipe({id:ItemID.crushedTetrahedrite,count:1,data:0},[{id:BlockID.oreTetrahedrite,data:0}]);
