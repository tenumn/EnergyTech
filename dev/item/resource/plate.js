...
Callback.addCallback("PreLoaded",function(){
    ...
    Recipe.addCompressorRecipe({id:ItemID.ingotBronze,data:0},{id:ItemID.plateBronze,count:1,data:0});
    ...
    for(let i in hammer){
        ...
        Recipe.addShapeless({id:ItemID.plateBronze,count:1,data:0},[{id:ItemID.ingotBronze,data:0},{id:ItemID.ingotBronze,data:0}],hammer[i]);
