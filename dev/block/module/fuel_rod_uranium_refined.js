// 燃料棒(精炼铀)
IDRegistry.genBlockID("fuelRodUraniumRefined");
Block.createBlock("fuelRodUraniumRefined",[
    {name:"Fuel Rod(Refined Uranium)",texture:[["machine_bottom",1],["machine_top",1],["fuel_rod_uranium",0]],inCreative:true}
...
BlockRenderer.enableCoordMapping(BlockID.fuelRodUraniumRefined,-1,render);

Block.registerDropFunction("fuelRodUraniumRefined",function(){return [];});
Block.registerPlaceFunction("fuelRodUraniumRefined",function(coords,item,block){
    var place = coords;
...
Machine.registerPrototype(BlockID.fuelRodUraniumRefined,{
